class SwapAllowedAndDisallowedSecuritySections < ActiveRecord::Migration[8.1]
  ...
  def down
    raise ActiveRecord::IrreversibleMigration, "security note sections were reordered"
  end
end
