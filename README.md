...
- Für `Eventim` gilt aktuell:
  ...
  - Bei SKS-Events mit gepflegter `SKS Sonderlocke` bleibt dieser Hinweis zusätzlich sichtbar, wenn das führende Status-Offer gleichzeitig `canceled` und `sold_out` signalisiert.
