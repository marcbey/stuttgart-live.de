module Backend
  module Events
    class EditorResponse
      def initialize(controller:, all_genres:, all_sub_genres:, all_presenters:, next_event_enabled:)
      ...
      attr_reader :all_genres, :all_sub_genres, :all_presenters, :controller, :next_event_enabled
