module Backend
  class VenuesController < BaseController
    ...
    def create
      ...
      if @venue.save
        redirect_to backend_venues_path, notice: "Venue wurde angelegt."
      else
    ...
    def update
      if @venue.update(venue_params)
        redirect_to backend_venues_path, notice: "Venue wurde gespeichert."
      else
    ...
    def venue_params
      params.require(:venue).permit(:name, :description, :external_url, :address, :logo)
    end
